...
static const struct ieee80211_regdomain regdom_ES = {
	...
	.reg_rules = {
		...
		REG_RULE(5170, 5250, 80, 20, 0, 0),
		REG_RULE(5250, 5330, 80, 20, 0, 0),
		REG_RULE(5490, 5710, 80, 27, 0, 0),
		REG_RULE(57240, 65880, 2160, 0, 40, 
			NL80211_RRF_NO_OUTDOOR | 0),
	},
	.n_reg_rules = 5
